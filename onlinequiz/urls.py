...
urlpatterns = [
    ...
    path('admin-dashboard/<int:pk>', views.admin_dashboard_deatil_view,name='admin-dashboard_detial'),
    ...
    path('admin-view-student-marks/<int:id>', views.admin_view_student_marks_view,name='admin-view-student-marks'),
